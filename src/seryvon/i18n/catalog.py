...
_REC_EN: dict[str, str] = {
    ...
    "img.svg_alt": "Add a <title>, aria-label, or aria-labelledby to content SVGs.",
    ...
    "aeo.comparison_tables": "Render comparison tables as static HTML <table> (not JS-only).",
    ...
    "geo.ssr": "Enable SSR or static prerendering so content is readable before JavaScript runs — one rendering-layer change covers every affected page, it is not a per-page fix.",
    ...
    "geo.primary_sources": "Embed external reference links in static HTML (not JS-rendered).",
...
_REC_FR: dict[str, str] = {
    ...
    "img.svg_alt": "Ajouter un <title>, aria-label ou aria-labelledby aux SVG de contenu.",
    ...
    "aeo.comparison_tables": "Rendre les tableaux de comparaison en HTML statique <table> (pas seulement JS).",
    ...
    "geo.ssr": "Activer le SSR ou le prérendu statique pour que le contenu soit lisible avant l'exécution du JavaScript — un seul changement au niveau du rendu couvre toutes les pages concernées, ce n'est pas une correction page par page.",
    ...
    "geo.primary_sources": "Intégrer les liens de référence externes dans le HTML statique (pas en JS).",
...
_REASON_EN: dict[str, str] = {
    ...
    "no_svg": "No non-decorative SVG to evaluate.",
    "no_forms": "No form to evaluate.",
...
_REASON_FR: dict[str, str] = {
    ...
    "no_svg": "Aucun SVG non décoratif à évaluer.",
    "no_forms": "Aucun formulaire à évaluer.",
...
_EXPL_EN: dict[str, str] = {
    "page_conformance": "{failing}/{total} non-conforming page(s) (mean score {score}).",
    "title_unique": "{unique} unique title(s) across {total} titled page(s).",
    "orphans": "{orphans} orphan page(s) out of {total} (excluding home).",
    "img_alt": "{without_alt}/{total} image(s) missing an alt attribute.",
    "img_svg_alt": "{without_name}/{total} content SVG(s) without an accessible name.",
    "indexable": "{non_indexable}/{total} non-indexable page(s).",
    "sitemap_valid": "Valid sitemap ({count} URLs).",
    "sitemap_invalid": "No valid sitemap found.",
    "https": "{non_https}/{total} page(s) not served over HTTPS.",
    ...
    "answer_directness": "{non_direct}/{total} page(s) without a lead answer paragraph.",
    "aeo_llm_citation": "Answer engine citation rate: {score}%.",
    "ssr": "A JS-free crawler sees {parity}% of the content on average. {csr} of {total} pages inject most of their content via JavaScript — one rendering-strategy issue, not {csr} separate fixes.",
    ...
    "primary_sources": "{without_sources}/{total} content page(s) (≥300 words) lack static-HTML outbound links to external sources. {excluded} lightweight page(s) excluded (listing/catalog pages are not expected to cite sources).",
    ...
    "accessible_forms": "{total}/{found} form(s) usable by an agent.",
...
_EXPL_FR: dict[str, str] = {
    "page_conformance": "{failing}/{total} page(s) non conforme(s) (score moyen {score}).",
    "title_unique": "{unique} title(s) unique(s) sur {total} page(s) titrée(s).",
    "orphans": "{orphans} page(s) orpheline(s) sur {total} (hors home).",
    "img_alt": "{without_alt}/{total} image(s) sans attribut alt.",
    "img_svg_alt": "{without_name}/{total} SVG de contenu sans nom accessible.",
    "indexable": "{non_indexable}/{total} page(s) non indexable(s).",
    "sitemap_valid": "Sitemap valide ({count} URLs).",
    "sitemap_invalid": "Aucun sitemap valide trouvé.",
    "https": "{non_https}/{total} page(s) non servie(s) en HTTPS.",
    ...
    "answer_directness": "{non_direct}/{total} page(s) sans paragraphe-réponse en tête.",
    "aeo_llm_citation": "Taux de citation answer engines : {score}%.",
    "ssr": "Un crawler sans JavaScript voit en moyenne {parity}% du contenu. {csr} pages sur {total} injectent l'essentiel de leur contenu via JavaScript — un seul problème de stratégie de rendu, pas {csr} corrections distinctes.",
    ...
    "primary_sources": "{without_sources}/{total} page(s) de contenu (≥300 mots) manquent de liens sortants externes dans le HTML statique. {excluded} page(s) légères exclues (listing/catalogue : non attendues à citer des sources).",
    ...
    "accessible_forms": "{total}/{found} formulaire(s) exploitable(s) par un agent.",
