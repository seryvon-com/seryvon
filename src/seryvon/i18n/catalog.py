...
_REC_EN: dict[str, str] = {
    ...
    "geo.ssr": "Serve content as static/prerendered HTML, readable before JavaScript executes.",
...
_REC_FR: dict[str, str] = {
    ...
    "geo.ssr": "Servir le contenu en HTML statique/prerendered, lisible avant exécution du JavaScript.",
...
_EXPL_EN: dict[str, str] = {
    ...
    "ssr": "Average content parity before JS: {parity}%. {csr}/{total} page(s) reveal substantial content only after JavaScript runs.",
...
_EXPL_FR: dict[str, str] = {
    ...
    "ssr": "Parité de contenu moyenne avant JS : {parity}%. {csr}/{total} page(s) ne révèlent une partie substantielle de leur contenu qu'après exécution du JavaScript.",
